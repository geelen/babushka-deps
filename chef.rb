dep 'chef installed' do
  requires 'chef', 'ohai'
  
  meet {
    # render these two files
    ...
    #then I want to install nginx and use this proxy to access the chef server config.
    #I don't understand the username file though. Chef has its own login. Do I need this?
