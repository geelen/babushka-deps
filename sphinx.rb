...
dep 'sphinx configured' do
  requires 'sphinx directory setup', 'sphinx config generated by ts'
...
dep 'sphinx config generated by ts' do
  met? { File.dirname(var(:ts_generated_config)).exists? }
  meet { shell "mkdir -p #{File.dirname(var(:ts_generated_config))}" }
end
