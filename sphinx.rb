...
dep 'sphinx configured' do
  requires 'sphinx directory setup', 'sphinx yml generated', 'sphinx config generated by ts'
...
dep 'sphinx config generated by ts' do
  ...
  meet {
    ...
    in_dir(var(:rails_root)) { shell "rake RAILS_ENV=production thinking_sphinx:configure" }
  }
end
